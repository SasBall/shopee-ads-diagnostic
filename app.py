...
def analyze_ads_data_with_gemini(data_dict):
    ...
    4. ช่วยบอกวิธีตั้ง ROAS อย่างละเอียดขิงสื้นค้าแต่ละชิ้น (จะต้องตั้งให้คุ้มค่าที่สุดไม่กินเงินไม่เปลืองเงินโดยเปล่าประโยชน์ เงินที่เสียไปกับ ROAS คือต้นทุนในการขายสิ้นค้า)
