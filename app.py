...
def analyze_ads_data_with_gemini(data_dict):
    ...
    หน้าที่ของคุณคือวิเคราะห์ข้อมูลจากรายงาน Shopee Ads และสรุปผลลัพธ์ที่สามารถนำไปใช้งานได้ทันที
    ...
    1. วิเคราะห์ข้อมูลทุกสินค้าโดยละเอียด
    
    2. คำนวณตัวเลขทั้งหมดให้เสร็จสมบูรณ์ เช่น
    - ROAS
    - CTR
    - CPC
    - CPM
    - Conversion Rate
    - ค่าใช้จ่ายต่อออเดอร์
    - ประสิทธิภาพของแต่ละสินค้า
    - เปรียบเทียบสินค้าทั้งหมด
    
    3. ห้ามอธิบายสูตรหรือวิธีคำนวณ
    
    4. แสดงเฉพาะผลลัพธ์ที่คำนวณเสร็จแล้ว พร้อมคำอธิบายสั้น ๆ
    
    5. สำหรับสินค้าทุกตัวให้สรุปว่า
    
    - ควรเพิ่มงบหรือไม่
    - ถ้าควรเพิ่ม ให้เพิ่มกี่เปอร์เซ็นต์
    - ควรลดงบหรือไม่
    - ถ้าควรลด ให้ลดกี่เปอร์เซ็นต์
    ...
    6. คำนวณ ROAS เป้าหมายที่เหมาะสมของสินค้าแต่ละตัว โดยพิจารณาจากข้อมูลที่ได้รับ และแสดงเฉพาะค่าที่แนะนำ ไม่ต้องอธิบายวิธีคิด
    
    7. ถ้าข้อมูลเพียงพอ ให้ประเมินงบโฆษณาที่เหมาะสมต่อวันของสินค้าแต่ละตัว พร้อมเหตุผลสั้น ๆ
    
    8. วิเคราะห์สินค้าที่เสียเงินโฆษณาโดยไม่คุ้มค่า และระบุว่าควรหยุดหรือปรับอะไร
    
    9. วิเคราะห์สินค้าที่มีโอกาสเติบโต และเสนอการเพิ่มงบที่เหมาะสม
    
    10. จัดลำดับสินค้าจากดีที่สุดไปแย่ที่สุด พร้อมคะแนนเต็ม 100
    
    11. สรุปภาพรวมของบัญชีโฆษณา
    
    12. สรุปแผนปฏิบัติสำหรับวันนี้ โดยเรียงตามความสำคัญ
    ...
    ห้ามแสดงขั้นตอนการคำนวณ
    
    ให้แสดงเฉพาะผลลัพธ์สุดท้ายที่คำนวณเสร็จแล้ว
    
    ใช้ Bullet Point และตารางให้อ่านง่าย
    
    หากข้อมูลไม่เพียงพอ ให้ระบุว่า "ข้อมูลไม่เพียงพอสำหรับการคำนวณ" และห้ามเดาหรือสร้างตัวเลขขึ้นเอง
    """
